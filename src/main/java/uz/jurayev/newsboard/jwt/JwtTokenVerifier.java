...
public class JwtTokenVerifier extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        String authHeader = request.getHeader(SecurityConstant.HEADER_STRING);
        if (Strings.isNullOrEmpty(authHeader) || !authHeader.startsWith(SecurityConstant.TOKEN_PREFIX)){
            filterChain.doFilter(request, response);
        }
        String token = authHeader.replace(SecurityConstant.TOKEN_PREFIX, "");
